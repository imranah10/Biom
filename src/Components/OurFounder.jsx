...
const OurFounder = () => {
  return (
    <section className="bg-indigo-500 rounded-md shadow-xl py-16 px-6 md:px-20">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        {/* Founder Details */}
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-6 text-white shadow-lg border border-white border-opacity-20 hover:shadow-2xl transition-all duration-300">
